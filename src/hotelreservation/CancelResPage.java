...
public class CancelResPage extends javax.swing.JFrame {
    ...
    private void refreshTable() {
        try {
            ...
            model.setRowCount(0);
            PreparedStatement stmt = con.prepareStatement("SELECT * FROM cancelresdb");
            ResultSet rs = stmt.executeQuery();
            while (rs.next()) {
                model.addRow(new Object[]{rs.getInt("RoomNum"), rs.getString("Reason"), rs.getTimestamp("DateTime")});
            }
            rs.close();
            stmt.close();
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        cancelRoomNum = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        cancelTable = new javax.swing.JTable();
        cancelReason = new javax.swing.JComboBox<>();
        insertAndRefreshButtonActionPerformed = new hotelreservation.Button();
        ...
        cancelRoomNum.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        cancelRoomNum.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.lightGray, java.awt.Color.gray));
        ...
        cancelTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Room Number", "Reason", "Date and Time of Cancellation"
            }
        ));
        ...
        insertAndRefreshButtonActionPerformed.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        insertAndRefreshButtonActionPerformed.setRadius(15);
        insertAndRefreshButtonActionPerformed.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                insertAndRefreshButtonActionPerformedActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cancelReason, javax.swing.GroupLayout.Alignment.TRAILING, 0, 248, Short.MAX_VALUE)
                                    .addComponent(cancelRoomNum))
                                .addGap(18, 18, 18)
                                .addComponent(insertAndRefreshButtonActionPerformed, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cancelRoomNum, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(cancelReason, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
                        .addComponent(insertAndRefreshButtonActionPerformed, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(32, 32, 32)
    ...
    private void insertAndRefreshButtonActionPerformedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertAndRefreshButtonActionPerformedActionPerformed
try {
            // Get current date and time
            Timestamp dateTime = new Timestamp(System.currentTimeMillis());
            String roomNumber = cancelRoomNum.getText();
            ...
            String reason = cancelReason.getSelectedItem().toString();
            
            // Insert cancellation data and update room availability
            PreparedStatement insertStmt = con.prepareStatement("INSERT INTO cancelresdb (RoomNum, Reason, DateTime) VALUES (?, ?, ?)");
            ...
            JOptionPane.showMessageDialog(this, "Cancellation recorded successfully!");
            cancelRoomNum.setText("");
    ...
    }//GEN-LAST:event_insertAndRefreshButtonActionPerformedActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelResPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancelResPage().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> cancelReason;
    private javax.swing.JTextField cancelRoomNum;
    private javax.swing.JTable cancelTable;
    private hotelreservation.Dashboard dashboard1;
    private hotelreservation.Button insertAndRefreshButtonActionPerformed;
